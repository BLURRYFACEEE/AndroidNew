...
/*    SimpleDateFormat simpleDateFormat=new SimpleDateFormat("MM-dd hh:mm");
    Date date = new Date();
    String format = simpleDateFormat.format(new Date(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE));*/
    /**
...
/*        long lt = new Long(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE);
        Date date = new Date(lt);
        res = simpleDateFormat.format(date);*/

/*        Integer.parseInt(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE);*/
...
//当搜索框内内容改变时执行的方法
            public boolean onQueryTextChange(String newText) {
                Log.d("Change!!!", "onCreateEditor:"+"Change!!");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_add:
                Log.d("Insert!!!", "onCreateEditor:"+R.id.menu_add);
                /*
            ...
            case R.id.menu_search:
                Log.d("Search!!!", "onCreateEditor:"+"QiFei！！！");
                /*
                 * Launches a new Activity using an Intent. The intent filter for the Activity
                 * has to have action ACTION_INSERT. No category is set, so DEFAULT is assumed.
                 * In effect, this starts the NoteEditor Activity in NotePad.
